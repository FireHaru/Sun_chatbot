...
/* Đảm bảo khung sidebar gốc làm chuẩn tọa độ */
[data-testid="stSidebar"] {
    position: relative !important;
}

/* Thêm padding dưới cùng để danh sách lịch sử chat không bị footer che mất khi cuộn */
[data-testid="stSidebarUserContent"] {
    padding-bottom: 60px !important;
}

/* Các tùy chỉnh spacing khác giữ nguyên */
.stTextInput {
...
section[data-testid="stSidebar"] .block-container {
    ...
    padding-bottom: 20px !important; /* chừa footer */
    margin: 0 !important;
}
